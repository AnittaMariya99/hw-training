...
class Crawler:
    ...
    def start(self):
        ...
        categories = [c for c in CategoryUrlItem.objects()]
        ...
        for category in categories:
            ...
            # "/ae/en/c/furniture-bedroom-beds"
            ...
            while True:
                ...
                if response.status_code == 200:
                    ...
                    logging.info(f"Failed to fetch page {page}")
                    break
    ...
    def parse_item(self, response, meta):
        ...
        if products:
            for product in products:
                ...
                details_string = product.get("summary", {}).get("en", "")
                ...
                for value in url_part.values():
                    if isinstance(value, dict) and "en" in value:
                        url_slug = value["en"]
                        url = "https://www.homecentre.com/ae/en/" + url_slug
                        break
