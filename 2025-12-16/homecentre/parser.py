...
class Crawler:
    ...
    def parse_item(self, response, meta):
        ...
        if groups:
            ...
            quantity = product_specs.get("Weight & Dimensions")
            material = product_specs.get("Material")
            specifications = product_specs.get("General Specifications")
            ...
            product_type = specifications.get("Type") if specifications else ""
